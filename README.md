...
graph LR
  ...
  subgraph Graph
    ...
    x0f8649c73df6fd69(["d_centre_coords"]):::uptodate --> xa9ea2a04c05eda30(["inset_maps"]):::outdated
    x6e986cb21b65ebaa(["d_icons"]):::outdated --> xa9ea2a04c05eda30(["inset_maps"]):::outdated
    x502e395192be8056(["plotting_utils"]):::uptodate --> xa9ea2a04c05eda30(["inset_maps"]):::outdated
    xce1d319486efc243(["vis_shapes"]):::outdated --> xa9ea2a04c05eda30(["inset_maps"]):::outdated
    ...
    x502e395192be8056(["plotting_utils"]):::uptodate --> x70fc135bdd27feb8(["qas_map"]):::outdated
    xce1d319486efc243(["vis_shapes"]):::outdated --> x70fc135bdd27feb8(["qas_map"]):::outdated
    x7ac64c2657a7a0da(["itraqi_list"]):::outdated --> x777ac6aa58ef6eb0(["iTRAQI_acute_maps"]):::outdated
    x502e395192be8056(["plotting_utils"]):::uptodate --> x777ac6aa58ef6eb0(["iTRAQI_acute_maps"]):::outdated
    ...
    x7ac64c2657a7a0da(["itraqi_list"]):::outdated --> x77bfd070d53e23a1(["iTRAQI_rehab_maps"]):::outdated
    x502e395192be8056(["plotting_utils"]):::uptodate --> x77bfd070d53e23a1(["iTRAQI_rehab_maps"]):::outdated
    ...
    x8e785e1ce1247c8f(["app_polygons"]):::uptodate --> xce1d319486efc243(["vis_shapes"]):::outdated
    x0f8649c73df6fd69(["d_centre_coords"]):::uptodate --> xce1d319486efc243(["vis_shapes"]):::outdated
    x6e986cb21b65ebaa(["d_icons"]):::outdated --> xce1d319486efc243(["vis_shapes"]):::outdated
    x21879eefff325d9d(["d_ids"]):::uptodate --> xce1d319486efc243(["vis_shapes"]):::outdated
    x831ee0369a2a91ad(["d_input_shapes"]):::uptodate --> xce1d319486efc243(["vis_shapes"]):::outdated
    x05f9b2be184bafe8(["d_qas_locations"]):::uptodate --> xce1d319486efc243(["vis_shapes"]):::outdated
    xc6a9168a5e03bc7c(["d_rsq_locations"]):::uptodate --> xce1d319486efc243(["vis_shapes"]):::outdated
    ...
    x502e395192be8056(["plotting_utils"]):::uptodate --> x8c11cc2ca92605fc(["major_regional_services_map"]):::outdated
    xce1d319486efc243(["vis_shapes"]):::outdated --> x8c11cc2ca92605fc(["major_regional_services_map"]):::outdated
    ...
    x7ac64c2657a7a0da(["itraqi_list"]):::outdated --> x4b49cbf96e14f716(["iTRAQI_sa2_map"]):::outdated
    x502e395192be8056(["plotting_utils"]):::uptodate --> x4b49cbf96e14f716(["iTRAQI_sa2_map"]):::outdated
    x7ac64c2657a7a0da(["itraqi_list"]):::outdated --> xd76909fa06094073(["iTRAQI_tables"]):::outdated
    x6aff51c44af250ba(["remoteness_files_files"]):::uptodate --> x2561c370ea702599["remoteness_files"]:::uptodate
    x7ac64c2657a7a0da(["itraqi_list"]):::outdated --> x9dc6b63955863bba(["iTRAQI_legends"]):::outdated
    x502e395192be8056(["plotting_utils"]):::uptodate --> x9dc6b63955863bba(["iTRAQI_legends"]):::outdated
    ...
    x3556cb9010710414(["d_acute_kriged_raster"]):::uptodate --> x7ac64c2657a7a0da(["itraqi_list"]):::outdated
    x5fb43595e3d9b43d(["d_rehab_kriged_raster"]):::uptodate --> x7ac64c2657a7a0da(["itraqi_list"]):::outdated
    xd6673f821e7b0465(["palette_file"]):::uptodate --> x7ac64c2657a7a0da(["itraqi_list"]):::outdated
    xce1d319486efc243(["vis_shapes"]):::outdated --> x7ac64c2657a7a0da(["itraqi_list"]):::outdated
    x7ac64c2657a7a0da(["itraqi_list"]):::outdated --> x15005b247f2f4537(["iTRAQI_sa1_map"]):::outdated
    x502e395192be8056(["plotting_utils"]):::uptodate --> x15005b247f2f4537(["iTRAQI_sa1_map"]):::outdated
    x502e395192be8056(["plotting_utils"]):::uptodate --> x0ef21ba3e3751955(["rsq_maps"]):::outdated
    xce1d319486efc243(["vis_shapes"]):::outdated --> x0ef21ba3e3751955(["rsq_maps"]):::outdated
    ...
    x502e395192be8056(["plotting_utils"]):::uptodate --> x2d0c593ea638a740(["town_locations_map"]):::outdated
    xce1d319486efc243(["vis_shapes"]):::outdated --> x2d0c593ea638a740(["town_locations_map"]):::outdated
    ...
    x7ac64c2657a7a0da(["itraqi_list"]):::outdated --> x6e1c1296adb53f85(["index_palette_table"]):::outdated
